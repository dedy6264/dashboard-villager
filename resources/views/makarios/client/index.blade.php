...
<main>
    <div class="px-4 container-fluid">
        ...
        <ol class="mb-4 breadcrumb">
            <li class="breadcrumb-item active">Client \ Client</li>
        </ol>
        <div class="mb-4 card">
            <div class="card-body">
                ...
                <form @submit.prevent="editMode ? updateData() : createData()" >
                    <div class="modal-body">
                        <div class="form-group">
                          ...
                          <input type="text"  class="form-control" v-model="form.client_name" aria-describedby="emailHelp" placeholder="Nama.." autofocus>
                        </div>
                    </div>
...
<script>
    ...
    createApp({
        setup(){
            ...
            const createData=()=>{
                axios.post('{{route('makarios.adddataclient')}}', {
            ...
            const updateData=()=>{
                axios.post('{{route('makarios.updatedataclient')}}',{

                    client_name:form.value.client_name,                    id:form.value.id,
                })
                .then(response => {
                    $('#dataModal').modal('hide');
                    refreshData();
            ...
            const refreshData=()=>{
                ...
                axios.post('{{route('makarios.getdataclient')}}')
                .then(response => {
            ...
            const deleteData=(id)=>{
                axios.get(`{{route('makarios.deletedataclient','')}}/${id}`)
                .then(response => {
                    refreshData();
                })
                .catch(error => {
