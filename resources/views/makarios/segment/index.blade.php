...
<main>
    <div class="px-4 container-fluid">
        <h1 class="mt-4">Segment</h1>
        <ol class="mb-4 breadcrumb">
            <li class="breadcrumb-item active">Segment \ Segment</li>
        </ol>
        <div class="mb-4 card">
            <div class="card-body">
                ...
                <form @submit.prevent="editMode ? updateData() : createData()" >
                    <div class="modal-body">
                        <div class="form-group">
                          ...
                          <input type="text"  class="form-control" v-model="form.segment_name" aria-describedby="emailHelp" placeholder="Nama.." autofocus>
                        </div>
                    </div>
...
<script>
    ...
    createApp({
        setup(){
            ...
            const createData=()=>{
                axios.post('{{route('makarios.adddatasegment')}}', {
            ...
            const updateData=()=>{
                axios.post('{{route('makarios.updatedatasegment')}}',{
                    segment_name:form.value.segment_name,
                    id:form.value.id,
                })
                .then(response => {
             ...
             const refreshData=()=>{
                ...
                axios.post('{{route('makarios.getdatasegment')}}')
                .then(response => {
            ...
            const deleteData=(id)=>{
                axios.get(`{{route('makarios.deletedatasegment','')}}/${id}`)
                .then(response => {
                    refreshData();
                })
                .catch(error => {
