...
<main>
    <div class="px-4 container-fluid">
        ...
        <ol class="mb-4 breadcrumb">
            <li class="breadcrumb-item active">Group \ Group</li>
        </ol>
        <div class="mb-4 card">
            <div class="card-body">
                ...
                <form @submit.prevent="editMode ? updateData() : createData()" >
                    <div class="modal-body">
                        <div class="form-group">
                          ...
                          <input type="text"  class="form-control" v-model="form.group_name" aria-describedby="emailHelp" placeholder="Nama Group.." autofocus>
                        </div>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
...
<script>
    ...
    createApp({
        setup(){
            ...
            const createData=()=>{
                axios.post('{{route('makarios.adddatagroup')}}', {
            ...
            const updateData=()=>{
                axios.post('{{route('makarios.updatedatagroup')}}',{
                    group_name:form.value.group_name,
                    group_name:form.value.group_name,
                    client_name:form.value.client_name,
                    client_name:form.value.client_name,
            ...
            const refreshData=()=>{
                ...
                axios.post('{{route('makarios.getdatagroup')}}')
                .then(response => {
            ...
            const deleteData=(id)=>{
                axios.get(`{{route('makarios.deletedatagroup','')}}/${id}`)
                .then(response => {
                    refreshData();
                })
                .catch(error => {
