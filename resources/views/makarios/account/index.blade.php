...
<main>
    <div class="px-4 container-fluid">
        ...
        <ol class="mb-4 breadcrumb">
            <li class="breadcrumb-item active">Account \ Account</li>
        </ol>
        <div class="mb-4 card">
            <div class="card-body">
                ...
                <form @submit.prevent="editMode ? updateData() : createData()" >
                    <div class="modal-body">
                        <div class="form-group">
                          ...
                          <input type="text"  class="form-control" v-model="form.account_name" aria-describedby="emailHelp" placeholder="Nama.." autofocus>
                        </div>
                    </div>
...
<script>
    ...
    createApp({
        setup(){
            ...
            const createData=()=>{
                axios.post('{{route('makarios.adddataaccount')}}', {
            ...
            const updateData=()=>{
                axios.post('{{route('makarios.updatedataaccount')}}',{

                    account_name:form.value.account_name,                    id:form.value.id,
                })
                .then(response => {
                    $('#dataModal').modal('hide');
                    refreshData();
            ...
            const refreshData=()=>{
                ...
                axios.post('{{route('makarios.getdataaccount')}}')
                .then(response => {
            ...
            const deleteData=(id)=>{
                axios.get(`{{route('makarios.deletedataaccount','')}}/${id}`)
                .then(response => {
                    refreshData();
                })
                .catch(error => {
