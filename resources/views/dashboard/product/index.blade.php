                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="modal-body">
                                ...
                                <select class="form-control" v-model='form.provider_id' @change="providerProductSelector(form.provider_id)">
                        ...
                        <div class="col-lg-6">
                            <div class="modal-body">
                                ...
                                <select class="form-control" v-model='form.product_provider_id' >
                                    <option value="-1"></option>
                                    <option v-for="item in productProviders" :key="item.id" :value="item.id" >@{{ item.productProviderName }}</option>
                                </select>
                                </div>
                            </div>
                        </div>
    ...
    createApp({
        setup(){
            ...
            const formSelector=()=>{
                ...
                productProviders.value.forEach((data) => {
                    if(data.id==form.value.product_provider_id){
