...
{{-- <div class="container mt-3 navbar fixed-top bg-slate-300"> --}}
    ...
    {{-- top navigation --}}
    <div class=" sb-topnav navbar navbar-expand navbar-dark bg-danger fixed-top">
        <div class="container">
            <div class="row">
                <div class="col-12">
...
<!-- Carousel -->
    <div id="promoCarousel" class=" carousel slide content-section" data-bs-ride="carousel" style="margin-top: 125px">
...
<!-- Produk -->
    <div class="container py-4 mt-0 mb-0 content-section" >
        <div class="text-center row g-2">
            <div class="col-4 ">
                <div class="">
                    <button class="btn service-card btn-success" type="submit">
...
<!-- Last Transaction -->
    <div class="container py-4 mt-0 content-section" style="margin-bottom: 50px">
        <div class="card">
...
<!-- Bottom Navigation -->
    <div class="navbar navbar-dark bg-danger navbar-expand d-md-none d-lg-none d-xl-none bottom-nav d-flex justify-content-around">
        <a href="{{route('m')}}">
