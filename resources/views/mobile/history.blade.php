...
<body class="" style="background-color:#81d0fd">
     {{-- top navigation --}}
    <div class=" sb-topnav navbar navbar-expand navbar-dark fixed-top" style="background-color:#81d0fd">
        <div class="container">
...
<!-- Last Transaction -->
    <div class="bg-white " style="margin-bottom:10px;margin-top:100px;border-radius:30px 30px 0px 0px">
...
<!-- Bottom Navigation -->
    <div class="navbar navbar-dark navbar-expand d-md-none d-lg-none d-xl-none bottom-nav d-flex justify-content-around" style="background-color:#81d0fd">
        <a href="{{route('m')}}">
