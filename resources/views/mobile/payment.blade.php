...
<body class="">
    <div class="container m-4"  style="margin-bottom:500px">
        <div>
        <img class="d-flex justify-content-center align-items-center" src="/assets/img/undraw_completing_gsf8.svg" alt="" sizes="" srcset="" style="width: 80%;margin-bottom:50px">
        </div>
        ...
        {{-- <div class=" bt-nav" style="margin-left: 50px;margin-right:50px;margin-bottom:50px">
                <div class="col-6">
                    <button type="button"  class="ml-4 mr-4 btn btn-primary btn-lg justify" style="width: 100%">Home</button>
                </div>
        </div> --}}
