    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body modal-dialog modal-dialog-scrollable">
                ...
                <div class="m-3 row" v-if="resData.subscriberNumber!==''">
                    <div class="text-left col-4 bg-slate-300">No Cust</div>
                    <div class="bg-red-600 col-8 text-end">@{{resData.subscriberNumber}}</div>
                </div>
            ...
            setup(){
                ...
                const dataPayment=()=>{
                    ...
                    switch (mainData.value.statusCode) {
                        ...
                        additionalData.value.statusTrx=mainData.value.statusDesc;
                            break;
                        case "09":
