...
@section('content')
    <div class="container pb-5">
        ...
        <div>
            ...
            <div class="p-3 transaction-card d-flex align-items-center" v-if="listTrx"
                ...
                >
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="small text-muted">@{{ trx.customerId }} &middot; 10.000</div>
        ...
        createApp({
            setup(){
                ...
                const openComplainDialog=(trx)=> {
                    ...
                    // contoh: this.$router.push({ name: 'complain', params: { id: trx.id } });
                };
                onMounted(() => {
                    getTrx();
