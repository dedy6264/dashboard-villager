...
class MerchantController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::withBasicAuth('joe','secret')->post('http://localhost:10010/merchant/add', $payload)->json();
    ...
    public function update(Request $request, Merchant $merchant)
    {
        ...
        $response = Http::withBasicAuth('joe','secret')->post('http://localhost:10010/merchant/update', $payload)->json();
        // dd($response);
        if ($response['statusCode'] !=="00" ) {
            return response()->json(['error' => 'Failed'], 500);
        }
    ...
    public function destroy($id)
    {
        ...
        $response = Http::withBasicAuth('joe','secret')->post('http://localhost:10010/merchant/drop', $payload)->json();
        // dd($response);
        if ($response['statusCode'] !=="00" ) {
            return response()->json(['error' => 'Failed'], 500);
        }
